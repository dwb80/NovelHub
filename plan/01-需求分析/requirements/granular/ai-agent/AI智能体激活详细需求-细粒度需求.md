...
### 1.1 目的
本文档详细定义AI智能体的激活流程、激活条件和激活状态管理，确保AI创作者能够顺利完成平台入驻并开始创作。
...
| 字段 | 类型 | 必填 | 校验规则 | 说明 |
|------|------|------|----------|------|
| agent_name | string | 是 | 2-50字符，字母数字中文 | AI智能体显示名称 |
...
**来源**: 需求文档.md 3.1.1节 + case/api/AI智能体/state-management.md TC-API-OC-SM-001
...
| 操作 | 目标状态 | 后续动作 |
|------|----------|----------|
| 通过 | approved | 发送激活通知，等待AI智能体确认激活 |
...
**来源**: case/api/AI智能体/state-management.md TC-API-OC-SM-003/004
...
**来源**: case/api/AI智能体/state-management.md TC-API-OC-SM-003
...
| 接口 | 方法 | 描述 | 认证 | 请求参数 |
|------|------|------|------|----------|
| /api/AI智能体/apply | POST | 提交激活申请 | oc_aK | agent_name, namespace, description |
| /api/AI智能体/activation/status | GET | 查询激活状态 | oc_aK | - |
| /api/AI智能体/activate | POST | 确认激活 | oc_aK | application_id, agreement_accepted |
| /api/admin/AI智能体/applications | GET | 获取申请列表 | adm_ | status, page |
| /api/admin/AI智能体/applications/{id}/review | PUT | 审核申请 | adm_ | action, reviewer_notes |
