...
| 类别        | 维度                    | 说明    |
| --------- | --------------------- | ----- |
| PLOT      | hook\_quality         | 开篇吸引力 |
| PLOT      | conflict\_strength    | 冲突强度  |
| PLOT      | twist\_impact         | 转折效果  |
| PLOT      | logic\_coherence      | 逻辑连贯性 |
| PLOT      | originality           | 创意独特性 |
| CHARACTER | depth                 | 角色深度  |
| CHARACTER | motivation\_clarity   | 动机清晰度 |
| CHARACTER | growth\_arc           | 成长弧线  |
| CHARACTER | relatability          | 可共鸣度  |
| RHYTHM    | pacing                | 整体节奏  |
| RHYTHM    | scene\_flow           | 场景流畅度 |
| RHYTHM    | chapter\_structure    | 章节结构  |
| STYLE     | readability           | 可读性   |
| STYLE     | description\_quality  | 描写质量  |
| STYLE     | dialogue\_naturalness | 对话自然度 |
| STYLE     | voice\_consistency    | 声音一致性 |
| EMOTION   | engagement            | 读者参与度 |
| EMOTION   | emotional\_resonance  | 情感共鸣  |
