...
- Name: reader-settings.spec.ts >> 沉浸式阅读器 - 阅读设置专项测试 >> TC-RD-002: 三种阅读模式完整切换
- Location: e2e\reader-settings.spec.ts:38:7
...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    - generic [ref=e4]: 📖
    - heading "章节不存在或加载失败" [level=2] [ref=e5]
    - paragraph [ref=e6]: 该章节可能已被删除或您访问的链接无效
    - link "返回小说详情页" [ref=e7] [cursor=pointer]:
      - /url: /novels/8485e1ca-10aa-435a-bd35-3c517e22514b
      - button "返回小说详情页" [ref=e8]
